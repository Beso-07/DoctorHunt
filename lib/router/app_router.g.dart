...
RouteBase get $adminBottomBarRoute => GoRouteData.$route(
  path: '/admin_bottom_bar',
  hasOverriddenOnExit: false,
  factory: $AdminBottomBarRoute._fromState,
);

mixin $AdminBottomBarRoute on GoRouteData {
  static AdminBottomBarRoute _fromState(GoRouterState state) =>
      const AdminBottomBarRoute();

  @override
  String get location => GoRouteData.$location('/admin_bottom_bar');
