...
import 'package:doctorhunt/feature/common/bottom_bar/presentation/pages/admin_bottom_bar.dart';
...
// ================= Main Layout =================
@TypedGoRoute<PatientBottomBarRoute>(path: '/patient_bottom_bar')
...
@TypedGoRoute<AdminBottomBarRoute>(path: '/admin_bottom_bar')
class AdminBottomBarRoute extends GoRouteData with $AdminBottomBarRoute {
  const AdminBottomBarRoute();

  @override
  Widget build(BuildContext context, GoRouterState state) => AdminBottomBar();
}
